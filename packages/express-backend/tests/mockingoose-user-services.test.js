...
describe('test mongoose User model', () => {
    ...
    it("createNewUser rejects duplicate usernames", async () => {
        ...
        const expectedUser = { _id: "69f13a139615c947306ab614", username: "ex-3", email: "ex-3@example.com", password: "hashed:secret", blockList: [], devices: [], flagList: [], permissions: 'regular', points: 3, };
    ...
    it("authenticateUser rejects banned users when permissions are banned", async () => {
        ...
        const expectedUser = { _id: "69f13a139615c947306ab614", username: "ex-4", email: "ex-4@example.com", password: "hashed:secret", blockList: [], devices: [], flagList: [], permissions: 'regular', points: 3, permissions: 'banned' };
